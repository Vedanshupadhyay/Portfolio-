      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-5 gap-10 items-center">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-lg text-muted-foreground mb-4">
              I thrive on solving complex problems, whether it's optimizing algorithms (thanks to my love for DSA and OOP) or architecting scalable cloud solutions. I'm constantly learning and exploring new tools to stay at the forefront of technology. I'm also proud to be a Google Student Ambassador.
            </p>
